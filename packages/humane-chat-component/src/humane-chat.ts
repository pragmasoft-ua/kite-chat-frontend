...
import humaneChatStyles from './humane-chat.css?inline';
...
export class HumaneChatElement extends LitElement {
  /**
   * opens chat dialog
   */
    ...
    return html`
      <div class="humane">
        ...
        >
          ...
          >
            <h3 class="humane-title flex-1">${this.heading}</h3>
            <span
              data-close
              title="Close"
  ...
  private _toggleOpen() {
    if (this.open) {
      const e = new CustomEvent('humane-chat.hide', {
        bubbles: true,
        composed: true,
        cancelable: true,
      });
      ...
      const e = new CustomEvent('humane-chat.show', {
        bubbles: true,
        composed: true,
        cancelable: true,
      });
