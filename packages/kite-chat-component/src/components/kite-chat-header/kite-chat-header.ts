...
export class KiteChatHeaderElement extends LitElement {
  ...
  private _handleCancel() {
    this.dispatchEvent(new CustomEvent('kite-chat-header.cancel', CUSTOM_EVENT_INIT));
  }

  private _handleEdit() {
    this.dispatchEvent(new CustomEvent('kite-chat-header.edit', CUSTOM_EVENT_INIT));
  }

  private _handleDelete() {
    this.dispatchEvent(new CustomEvent('kite-chat-header.delete', CUSTOM_EVENT_INIT));
  }

  private _handleClose() {
    this.dispatchEvent(new CustomEvent('kite-chat-header.close', CUSTOM_EVENT_INIT));
  }
