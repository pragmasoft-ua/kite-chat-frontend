...
import InlineKeyboardExample from '@components/InlineKeyboardExample.astro';
...
<kite-msg>
    Did you know they have a youtube channel? \[Check it out!\](https://www.youtube.com/)
    <kite-custom-keyboard  class="custom-keyboard-example" slot="inline-keyboard"></kite-custom-keyboard>
</kite-msg>
<InlineKeyboardExample id="custom-keyboard-example"/>
````html
<kite-msg>
    Did you know they have a youtube channel? \[Check it out!\](https://www.youtube.com/)
    <kite-custom-keyboard slot="inline-keyboard"></kite-custom-keyboard>
</kite-msg>
<script>
    document.querySelector(`kite-custom-keyboard`).keyboard = [
        [
            {text: 'Yes', callbackData: 'YES'}, 
            {text: 'No', callbackData: 'NO'},
        ], 
        [
            {text: 'Google', callbackData: 'SEARCH', url: 'https://www.google.com/'}, 
            {text: 'Not sure', callbackData: 'NOT_SURE'}, 
            {text: 'Cancel', callbackData: 'BACK'},
        ], 
    ];
</script>
````
