...
export class HumaneChatElement extends LitElement {
  /**
   * User id, optional, autogenerated like <pre>humane-user-<RANDOM-STRING></pre> if not provided
   */
  @property({reflect: true})
  readonly userId = `humane-user-${randomStringId()}`;

  /**
   * Chat id, optional, autogenerated with nanoid if not provided
   */
  @property({reflect: true})
  readonly chatId = `humane-chat-${randomStringId()}`;
